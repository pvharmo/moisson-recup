<script lang="ts">
	...
	export let title = "Quelque chose s'est mal passé.";
	export let description =
		"Notre serveur est actuellement victime d'un moment de 'je-n'ai-aucune-idée-de-ce-que-je-fais'. Veuillez patienter ou contactez nous si l'erreur persiste.";
	export let image = {
		src: '/images/500.svg',
		alt: 'astronaut'
	};
	export let btnHref = "/" + $page.url.pathname.split('/')[1] || "/";
	export let btnTitle = 'Retourner à l\'accueil';
