<script lang="ts">
	...
	let posts = [
		{ name: 'Récupérations', icon: CirclePlusSolid, href: '/recup' },
		{
			name: 'Rapports',
			icon: ChartOutline,
			children: {
				"Toutes les récupérations": '/recup/rapports/tout',
				"Douze derniers mois": '/recup/rapports/12mois',
				"Année fiscale en cours": '/recup/rapports/annee_fiscale',
				"Année fiscale précédente": '/recup/rapports/annee_fiscale_precedente',
				"Excel": '/recup/rapports/excel'
			}
		},
		{
			name: 'Administration',
